...
export const addCleaningSupplies = async (req, res) => {
  try {
    ...
    const newItem = new cleaningSupplies({
      ...req.body,
...
export const getAllCleaningSupllies = async (req, res) => {
  try {
    const userId = req.userId;
    const items = await cleaningSupplies
      .find({ user: userId })
      .sort({ updatedAt: -1 });
...
export const getCleaningSupplyById = async (req, res) => {
  try {
    const userId = req.userId;
    const item = await cleaningSupplies.findOne({
      _id: req.params.id,
...
export const updateCleaningSupplyById = async (req, res) => {
  try {
    ...
    const updatedItem = await cleaningSupplies.findOneAndUpdate(
...
export const deleteCleaningSupplyById = async (req, res) => {
  try {
    const userId = req.userId;
    const deletedItem = await cleaningSupplies.findOneAndDelete({
      _id: req.params.id,
