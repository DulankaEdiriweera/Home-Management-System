...
const PersonalCare = () => {
  ...
  const [personalCareItems, setpersonalCareItems] = useState([]); // State to store fetched items
  ...
  // Fetch Personal Care Items from backend using Axios
  useEffect(() => {
      ...
      if (result.isConfirmed) {
        try {
          ...
          setpersonalCareItems(
            personalCareItems.filter((item) => item._id !== itemId)
          );
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Personal Care Items Inventory Report", 14, 20);
  ...
  return (
    <div className="flex p-2">
          ...
          <div className="flex space-x-2">
            <button
              ...
              onClick={() => {
                ...
                setIsCloseToExpiry(false);
                navigate("/personalCare"); // Fetch all items again
              }}
            >
              All Items
            </button>
      ...
      <ReusablePopUp
        ...
        title="View Personal Care Item Details"
      >
        {viewItem && (
          <ReusableForm
            fields={[
