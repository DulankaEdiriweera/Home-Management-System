...
const ToolsAndMaintainenceItems = () => {
  ...
  // Fetch Tool items from backend using Axios
  useEffect(() => {
  ...
  const filteredItems = toolItems.filter(
    (item) =>
  ...
  const handleDeleteClick = async (itemId) => {
    if (window.confirm("Are you sure you want to delete this item?")) {
      try {
        ...
        settoolItems(toolItems.filter((item) => item._id !== itemId)); // Update the UI to reflect deletion
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Tools & Mainatnence Items Inventory Report", 14, 20);
    ...
    doc.save("Tools&Maintanence_Inventory.pdf");
  };
  ...
  return (
    <div className="flex p-2">
      ...
      <ReusablePopUp
        ...
        title="Add New Tool or Maintainence Item"
      >
        <ReusableForm
          fields={formFields}
      ...
      <ReusablePopUp
        ...
        title="View Tool or Maintainence Item Details"
      >
        {viewItem && (
          <ReusableForm
            fields={[
      ...
      <ReusablePopUp
        ...
        title="Edit Tool or Maintainence Items"
      >
        {editItem && (
          <ReusableForm
            fields={[
